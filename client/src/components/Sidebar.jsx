...
const Sidebar = () => {
   ...
   return (
      <div className={`container-profile-s ${selectedUser ? 'max-md:hidden' : ''}`}>
         ...
         <div className='pb-5'>
            ...
            <div className='flex justify-between items-center'>
               ...
               <div className='relative py-2 group'>
                  ...
                  <div className='profile-style'>
                     <p onClick={() => navigate('/profile')} className='cursor-pointer text-sms' >Edit Profile</p>
                     <hr className='my-2 border-t border-gray-500' />
                     <p onClick={() => logout()} className='cursor-pointer text-sms'>Logout</p>
                  </div>
               </div>
            </div>
            ...
            <div className='bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-5'>
               ...
               <input onChange={(e) => setInput(e.target.value)}
                  type="text" className='input-search' placeholder='Search User...' />
            </div>
